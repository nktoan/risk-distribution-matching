...
if __name__ == "__main__":
    ...
    # Algorithms
    parser.add_argument('--algorithm', type=str, default='rdm')
    parser.add_argument('--penalty_weight', type=float, default=1000)           # rdm, irm, vrex, etc.
    parser.add_argument('--variance_weight', type=float, default=0.005)          # rdm
